<x-app-layout>
    ...
    .btn-submit {
        ...
        color: white;
        border-radius: 9999px; /* arrondi parfait */
    ...
    /* Bouton Annuler */
    .btn-cancel {
        background: linear-gradient(135deg, rgb(212, 188, 188), rgb(230, 10, 10));
        border: 2px solidrgb(63, 34, 209);
        color: white;
        border-radius: 9999px; /* arrondi parfait */
        box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2);
    }
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <form method="POST" action="{{ url('/toad/film/add') }}" class="border border-gray-300 bg-white p-6 rounded shadow-md">
            ...
            <!-- Partie : Informations sur l'inventaire -->
