<x-app-layout>
    ...
    .btn-search:hover {
        ...
        box-shadow: 0 6px 8px rgb(16, 36, 217);
    ...
    .btn-custom {
        ...
        border-radius: 9999px;
        box-shadow: 0 6px 8px rgba(8, 8, 8, 0.41);
    }
    .btn-edit {
    ...
    .card {
        ...
        box-shadow: 0 6px 8px rgb(9, 9, 9);
    }
    .card:hover {
        transform: scale(1.05);
        box-shadow: 0 6px 8px rgba(25, 92, 199, 0.74);
    }
    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="toolbar flex flex-wrap gap-6 justify-center md:justify-between items-center mb-10">
               <a href="{{ url('inventory/create') }}" class="btn-create">
                   Ajouter un film
               </a>
